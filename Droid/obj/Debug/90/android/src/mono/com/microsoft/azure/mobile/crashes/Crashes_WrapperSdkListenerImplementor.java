...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Microsoft.Azure.Mobile.Crashes.AndroidCrashes+IWrapperSdkListenerImplementor, Microsoft.Azure.Mobile.Crashes.Android.Bindings", Crashes_WrapperSdkListenerImplementor.class, __md_methods);
	}


	public Crashes_WrapperSdkListenerImplementor ()
	{
		super ();
		if (getClass () == Crashes_WrapperSdkListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Microsoft.Azure.Mobile.Crashes.AndroidCrashes+IWrapperSdkListenerImplementor, Microsoft.Azure.Mobile.Crashes.Android.Bindings", "", this, new java.lang.Object[] {  });
	}
